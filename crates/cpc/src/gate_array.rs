...
impl Palette {
    pub fn color(&self) -> u32 {
        match self {
            Self::Black => 0x000000FF,
            Self::Blue => 0x000080FF,
            Self::BrightBlue => 0x0000FFFF,
            Self::Red => 0x800000FF,
            Self::Magenta => 0x800080FF,
            Self::Mauve => 0x8000FFFF,
            Self::BrightRed => 0xFF0000FF,
            Self::Purple => 0xFF0080FF,
            Self::BrightMagenta => 0xFF00FFFF,
            Self::Green => 0x008000FF,
            Self::Cyan => 0x008080FF,
            Self::SkyBlue => 0x0080FFFF,
            Self::Yellow => 0x808000FF,
            Self::White => 0x808080FF,
            Self::PastelBlue => 0x8080FFFF,
            Self::Orange => 0xFF8000FF,
            Self::Pink => 0xFF8080FF,
            Self::PastelMagenta => 0xFF80FFFF,
            Self::BrightGreen => 0x00FF00FF,
            Self::SeaGreen => 0x00FF80FF,
            Self::BrightCyan => 0x00FFFFFF,
            Self::Lime => 0x80FF00FF,
            Self::PastelGreen => 0x80FF80FF,
            Self::PastelCyan => 0x80FFFFFF,
            Self::BrightYellow => 0xFFFF00FF,
            Self::PastelYellow => 0xFFFF80FF,
            Self::BrightWhite => 0xFFFFFFFF,
        }
    }
}
